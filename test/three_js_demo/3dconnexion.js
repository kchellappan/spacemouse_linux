 ...
 * NOTE: Unminified using https://unminify.com/
 *
...
_3Dconnexion = function (n) {
    ...
    this.V3DK_FIT = 31;
    this.V3DK_MENU = 30;
    this.fnUpdate = { motion: this.onMotion.bind(this), "events.keyPress": this.onKeyPress.bind(this), "events.keyRelease": this.onKeyRelease.bind(this) };
    this.clientFnRead = {
        ...
        "model.floorPlane": n.getFloorPlane,
        "model.unitsToMeters": n.getUnitsToMeters,
...
_3Dconnexion.prototype.create3dmouse = function (n, t, i) {
    ...
    r.session.call("3dx_rpc:create", "3dconnexion:3dmouse", r.version).then(
        function (n) {
            ...
            var u = { version: parseFloat(r.version), name: t, rowMajorOrder: (i & _3Dconnexion.nlOptions.rowMajorOrder) != 0 };
                ...
                function (n) {
                    ...
                    document.hasFocus() &&
                        (document.activeElement === document.body || document.activeElement === null
                            ...
                            : r.viewport.contains(document.activeElement) && (r.focus(), r.debug && console.log("self.viewport has focus")));
...
_3Dconnexion.prototype.delete3dmouse = function () {
    ...
    n.viewport !== null && (n.viewport.removeEventListener("focus", n.focus), n.viewport.removeEventListener("blur", n.blur));
    n.session &&
...
Object.freeze((_3Dconnexion.SiActionNodeType_t = { SI_ACTIONSET_NODE: 0, SI_CATEGORY_NODE: 1, SI_ACTION_NODE: 2 }));
_3Dconnexion.ActionNode = function (n, t, i) {
    return (this.id = n), (this.label = t || n), (this.type = i), this;
};
_3Dconnexion.ActionNode.prototype = { constructor: _3Dconnexion.ActionNode, id: { value: null, enumerable: !0 }, label: { value: null, writable: !0, enumerable: !0 }, type: { value: null, enumerable: !0 } };
...
_3Dconnexion.Action.prototype = Object.create(_3Dconnexion.ActionNode.prototype, { constructor: { value: _3Dconnexion.Action }, description: { value: "", writable: !0, enumerable: !0 } });
...
_3Dconnexion.ActionSet.prototype = Object.create(_3Dconnexion.ActionTreeNode.prototype, { constructor: { value: _3Dconnexion.ActionSet } });
...
_3Dconnexion.Category.prototype = Object.create(_3Dconnexion.ActionTreeNode.prototype, { constructor: { value: _3Dconnexion.Category } });
...
Object.freeze((_3Dconnexion.SiImageType_t = { e_none: 0, e_image_file: 1, e_resource_file: 2, e_image: 3 }));
_3Dconnexion.ImageItem.prototype = { constructor: _3Dconnexion.ImageItem, id: { value: "", writable: !0 }, type: { value: "e_none", enumerable: !0 } };
_3Dconnexion.ImageItem.fromImage = function (n, t) {
    ...
    return Object.defineProperties(i, {
        ...
        data: { value: _3Dconnexion.ImageItem.base64FromArrayBuffer(n), enumerable: !0 },
        status: { value: 200 },
    });
};
...
_3Dconnexion.ImageItem.base64FromArrayBuffer = function (n) {
    for (var u = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/=", t = new Uint8Array(n), e = t.length % 3, f = t.length - e, i = "", r = 0; r < f; r += 3)
        (i += u[t[r] >> 2]), (i += u[((t[r] & 3) << 4) | (t[r + 1] >> 4)]), (i += u[((t[r + 1] & 15) << 2) | (t[r + 2] >> 6)]), (i += u[t[r + 2] & 63]);
 ...
 */
(function (n) {
    n || (n = window.console = { log: function () {}, info: function () {}, warn: function () {}, error: function () {} });
    ...
    typeof n.log == "object" &&
        ((n.log = Function.prototype.call.bind(n.log, n)), (n.info = Function.prototype.call.bind(n.info, n)), (n.warn = Function.prototype.call.bind(n.warn, n)), (n.error = Function.prototype.call.bind(n.error, n)));
    "group" in n ||
        (n.group = function (t) {
            n.info("\n--- " + t + " ---\n");
        });
...
when = (function (n) {
    ...
    function yt() {
        ...
        var n, i, t;
        return (n = { promise: u, resolve: u, reject: u, notify: u, resolver: { resolve: u, reject: u, notify: u } }), (n.promise = i = e(f)), n;
    }
    function w(n, t) {
    ...
    else if ((ct = (typeof MutationObserver == "function" && MutationObserver) || (typeof WebKitMutationObserver == "function" && WebKitMutationObserver)))
        s = (function (n, t, i) {
            ...
            r = (f.WordArray = i.extend({
                ...
                concat: function (n) {
                    var i = this.words,
                        ...
                        e,
                        t;
                    if ((this.clamp(), u % 4)) for (t = 0; t < f; t++) (e = (r[t >>> 2] >>> (24 - (t % 4) * 8)) & 255), (i[(u + t) >>> 2] |= e << (24 - ((u + t) % 4) * 8));
                ...
                stringify: function (n) {
                    ...
                    for (n.clamp(), i = [], t = 0; t < e; t += 3) {
                        var s = (u[t >>> 2] >>> (24 - (t % 4) * 8)) & 255,
                            ...
                            l = (s << 16) | (h << 8) | c;
                        for (r = 0; r < 4 && t + r * 0.75 < e; r++) i.push(o.charAt((l >>> (6 * (3 - r))) & 63));
                    }
                ...
                compute: function (n, t) {
                    for (var s = this.cfg, r = e.create(s.hasher, n), f = u.create(), l = u.create([1]), p = f.words, w = l.words, a = s.keySize, b = s.iterations, o, c, y, i; p.length < a; ) {
                        ...
                        var v = o.words,
                            k = v.length,
                            h = o;
                        for (c = 1; c < b; c++) for (h = r.finalize(h), r.reset(), y = h.words, i = 0; i < k; i++) v[i] ^= y[i];
                        f.concat(o);
                        w[0]++;
                    }
    ...
    (function (n, t) {
        ...
        return (
                ...
                Array.prototype.indexOf ||
                    (Array.prototype.indexOf = function (n) {
                        ...
                        if (
                            ...
                            ((t = 0), arguments.length > 0 && ((t = Number(arguments[1])), t !== t ? (t = 0) : t !== 0 && t !== Infinity && t !== -Infinity && (t = (t > 0 || -1) * Math.floor(Math.abs(t)))), t >= r)
                        )
                            return -1;
            ...
            (i.deriveKey = function (n, t) {
                if (t && t.salt) {
                    var i = t.salt,
                        r = t.keylen || 32,
                        u = t.iterations || 1e4,
                        f = CryptoJS.PBKDF2(n, i, { keySize: r / 4, iterations: u, hasher: CryptoJS.algo.SHA256 });
            ...
            (i.PrefixMap.prototype.shrink = function (n, t) {
                for (var u, r, f = this, i = n.length; i > 0; i -= 1) if (((u = n.substring(0, i)), (r = f._rindex[u]), r)) return r + ":" + n.substring(i);
                return t === !0 ? n : null;
            }),
            ...
            (i.Session = function (n, t, r, u) {
                ...
                if (
                    ...
                    (f._txcnt = 0),
                    (f._rxcnt = 0),
                    (f._websocket = f._options && f._options.skipSubprotocolAnnounce ? i._construct(f._wsuri) : i._construct(f._wsuri, [i._subprotocol])),
                    !f._websocket)
                ) {
                    if (r !== undefined) {
                ...
                f._websocket.onmessage = function (n) {
                    ...
                    if (
                        (i._debugws && ((f._rxcnt += 1), console.group("WS Receive"), console.info(f._wsuri + "  [" + f._session_id + "]"), console.log(f._rxcnt), console.log(n.data), console.groupEnd()),
                        (t = JSON.parse(n.data)),
                        t[1] in f._calls)
                    ) {
                        if (t[0] === i._MESSAGE_TYPEID_CALL_RESULT) {
                            ...
                            o !== undefined ? u.reject({ uri: l, desc: a, detail: o }) : u.reject({ uri: l, desc: a });
                        }
                        delete f._calls[t[1]];
                        ...
                        (y = f._prefixes.resolve(t[1], !0)),
                            y in f._subscriptions &&
                                ((p = t[1]),
                                (w = t[2]),
                                i._debugpubsub && (console.group("WAMP Event"), console.info(f._wsuri + "  [" + f._session_id + "]"), console.log(p), console.log(w), console.groupEnd()),
                        ...
                        if (f._session_id === null)
                            (f._session_id = t[1]),
                                (f._wamp_version = t[2]),
                                (f._server = t[3]),
                                (i._debugrpc || i._debugpubsub) && (console.group("WAMP Welcome"), console.info(f._wsuri + "  [" + f._session_id + "]"), console.log(f._wamp_version), console.log(f._server), console.groupEnd()),
                ...
                f._websocket.onopen = function () {
                    if (f._websocket.protocol !== i._subprotocol)
                        if (typeof f._websocket.protocol == "undefined")
                            i._debugws && (console.group("WS Warning"), console.info(f._wsuri), console.log("WebSocket object has no protocol attribute: WAMP subprotocol check skipped!"), console.groupEnd());
                        else if (f._options && f._options.skipSubprotocolCheck)
                            i._debugws && (console.group("WS Warning"), console.info(f._wsuri), console.log("Server does not speak WAMP, but subprotocol check disabled by option!"), console.log(f._websocket.protocol), console.groupEnd());
                        else {
                ...
                f._websocket.onclose = function (n) {
                    i._debugws &&
                        (f._websocket_connected
                            ? console.log("Autobahn connection to " + f._wsuri + " lost (code " + n.code + ", reason '" + n.reason + "', wasClean " + n.wasClean + ").")
                            : console.log("Autobahn could not connect to " + f._wsuri + " (code " + n.code + ", reason '" + n.reason + "', wasClean " + n.wasClean + ")."));
                    f._websocket_onclose !== undefined &&
                        (f._websocket_connected ? (n.wasClean ? f._websocket_onclose(i.CONNECTION_CLOSED, "WS-" + n.code + ": " + n.reason) : f._websocket_onclose(i.CONNECTION_LOST)) : f._websocket_onclose(i.CONNECTION_UNREACHABLE));
                    f._websocket_connected = !1;
                    f._wsuri = null;
            ...
            (i.Session.prototype.call = function () {
                for (var t = this, n = new i.Deferred(), r, e, u, f; ; ) if (((r = i._newidFast()), !(r in t._calls))) break;
            ...
            (i.Session.prototype.subscribe = function (n, t) {
                ...
                if (
                    (u in r._subscriptions ||
                        (i._debugpubsub && (console.group("WAMP Subscribe"), console.info(r._wsuri + "  [" + r._session_id + "]"), console.log(n), console.log(t), console.groupEnd()),
            ...
            (i.Session.prototype.unsubscribe = function (n, t) {
                ...
                if (u in r._subscriptions) {
                    ...
                    r._subscriptions[u].length === 0 &&
                        ...
                        i._debugpubsub && (console.group("WAMP Unsubscribe"), console.info(r._wsuri + "  [" + r._session_id + "]"), console.log(n), console.log(f), console.groupEnd()),
            ...
            (i.Session.prototype.publish = function () {
                ...
                i._debugpubsub &&
                    ...
                    console.log(t),
                    console.log(r),
                    f !== null ? console.log(f) : n !== null && (console.log(n), e !== null && console.log(e)),
                    console.groupEnd());
                o._send(u);
            }),
                        ...
                        switch (r) {
                                ...
                                if (((t.retryCount += 1), t.connects === 0)) t.onHangup(r, "Connection could not be established.");
                                    ...
                                    if (
                                        ((f = t.onHangup(
                                            ...
                                            "Connection unreachable - scheduled reconnect to occur in " + t.options.retryDelay / 1e3 + " second(s) - attempt " + t.retryCount + " of " + t.options.maxRetries + ".",
                                            { delay: t.options.retryDelay, retries: t.retryCount, maxretries: t.options.maxRetries }
                                        )),
                                        f)
                                    ) {
                                        ...
                                        i._debugconnect && console.log("Connection unreachable - retrying (" + t.retryCount + ") .."),
                            ...
                            case i.CONNECTION_LOST:
                                if (((t.retryCount += 1), t.retryCount <= t.options.maxRetries))
                                    if (
                                        ((f = t.onHangup(i.CONNECTION_LOST_SCHEDULED_RECONNECT, "Connection lost - scheduled " + t.retryCount + "th reconnect to occur in " + t.options.retryDelay / 1e3 + " second(s).", {
                                        ...
                                        i._debugconnect && console.log("Connection lost - retrying (" + t.retryCount + ") .."),
                                            n.setTimeout(function () {
                                                i._connect(t);
                                            }, t.options.retryDelay);
            ...
            (i.connect = function (n, t, r, u) {
                ...
                if (
                    ...
                    f.options.skipSubprotocolAnnounce === undefined && (f.options.skipSubprotocolAnnounce = !1),
                    t)
                )
                    f.onConnect = t;
    ...
    return n.indexOf("MSIE") > -1
        ...
        ? ((t = ab._matchRegex(n, ab._UA_WEBKIT)), t)
            ? n.indexOf("Windows") > -1 && t == "534+"
                ? [!0, !1, !0]
                : n.indexOf("Macintosh") > -1 && ((t = t.replace("+", "").split(".")), (parseInt(t[0]) == 535 && parseInt(t[1]) >= 24) || parseInt(t[0]) > 535)
                ? [!0, !1, !0]
                : n.indexOf("webOS") > -1
